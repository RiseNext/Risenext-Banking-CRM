...
export default function CustomersPage() {
  ...
  function downloadDraftApplication() {
    ...
    const fileName =
      `${safeApplicantName}-draft-application.html`;
...
<html lang="en">
  ...
  <body>
    ...
    <div class="section">
      ...
      <div class="row">
        <span>Bank</span>
        <strong>${bankName(resolvedBankId) || "—"}</strong>
      </div>
      ...
      <div class="row">
        <span>Income</span>
        <strong>
          ${formatCurrency(num(form.monthlyIncome))}
        </strong>
      </div>
    </div>

    <p>
      Use this draft for manual verification and
    ...
    <>
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <StatCard
          ...
          icon={Users}
          accent="var(--success)"
          helper={`${verifiedPercentage}% of book`}
          index={1}
        />
