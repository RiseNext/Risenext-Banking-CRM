...
export default function SettingsPage() {
  ...
  /* -------------------------------------------------------------------------- */
  /* Sync profile when auth user becomes available                              */
  /* -------------------------------------------------------------------------- */
  ...
  function handleAvatarChange(
    ...
    toast.success("Photo selected", {
      description: "Click Save changes to apply it.",
    });
  }
  ...
  async function saveProfile() {
    try {
      ...
      // avatarFile is intentionally kept for future backend upload integration.
      void avatarFile;
    } catch (error) {
      console.error(error);
  ...
  function handlePasswordUpdate() {
    toast.success("Password updated", {
      description: "Sign in again on other devices.",
    });
  }
            ...
            >
              {[
                ...
                },
                {
                  ...
                  description: "Use ₹ L and ₹ Cr formatting",
                },
                {
                  label: "Open records in dialog",
                  description: "Instead of a full page",
                },
              ].map((item, index) => (
                <div
                  key={item.label}
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            ...
            >
              {[
                ...
                {
                  label: "Email",
                  value: email || "admin@risenext.com",
                  locked: false,
                },
                {
                  label: "SMS",
          ...
          <div className="grid gap-4 lg:grid-cols-3">
            ...
            >
              ...
              <p className="flex items-center gap-1.5 text-[11px] text-[var(--muted-foreground)]">
                ...
                Recommended for Admin and Super Admin roles.
              </p>
            </SectionCard>
            ...
            >
              <div className="flex flex-wrap items-center justify-between gap-3 rounded-lg border border-[var(--border)] p-3">
                <div>
                  ...
                  <p className="text-[11px] text-[var(--muted-foreground)]">
                    Customers, loans, documents index, and ledger
                    as a single archive
                  </p>
                </div>
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 rounded-lg border border-[var(--danger)] bg-[var(--danger-soft)] p-3">
                <div>
                  ...
                  <p className="text-[11px] text-[var(--muted-foreground)]">
                    Restores the sample customers, loans, and
                    ledger entries
                  </p>
                </div>
